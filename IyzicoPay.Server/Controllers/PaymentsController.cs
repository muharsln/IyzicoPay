...
namespace IyzicoPay.Server.Controllers;
...
public class PaymentsController : ControllerBase
{
    ...
    public async Task<IActionResult> Pay()
    {
        Options options = new()
        {
            ApiKey = "sandbox-fwurQgy4dR1YzHzikMkdzsmr6SZ4faMy",
            SecretKey = "sandbox-LCydS0JgOZ8GraJF4jpRXwhwcrf8X1QO",
        ...
        request.CallbackUrl = "https://localhost:7039/api/Payments/PayCallBack";
